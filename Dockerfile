...
# protoc-gogo series
RUN go get -u github.com/gogo/protobuf/protoc-gen-gogo@v1.3.2
RUN go get -u github.com/gogo/protobuf/protoc-gen-gofast@v1.3.2
RUN go get -u github.com/gogo/protobuf/protoc-gen-gogofast@v1.3.2
RUN go get -u github.com/gogo/protobuf/protoc-gen-gogoslick@v1.3.2
