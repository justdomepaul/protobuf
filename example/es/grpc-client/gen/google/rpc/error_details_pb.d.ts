 ...
 * @generated from message google.rpc.ErrorInfo
 */
export declare type ErrorInfoJson = {
  /**
   * The reason of the error. This is a constant value that identifies the
   * proximate cause of the error. Error reasons are unique within a particular
   * domain of errors. This should be at most 63 characters and match a
 ...
 */
export declare const ErrorInfoSchema: GenMessage<ErrorInfo, {jsonType: ErrorInfoJson}>;
 ...
 * @generated from message google.rpc.RetryInfo
 */
export declare type RetryInfoJson = {
  /**
   * Clients should wait at least this long between retrying the same request.
   *
   * @generated from field: google.protobuf.Duration retry_delay = 1;
 ...
 */
export declare const RetryInfoSchema: GenMessage<RetryInfo, {jsonType: RetryInfoJson}>;
 ...
 * @generated from message google.rpc.DebugInfo
 */
export declare type DebugInfoJson = {
  /**
   * The stack trace entries indicating where the error occurred.
   *
   * @generated from field: repeated string stack_entries = 1;
 ...
 */
export declare const DebugInfoSchema: GenMessage<DebugInfo, {jsonType: DebugInfoJson}>;
 ...
 * @generated from message google.rpc.QuotaFailure
 */
export declare type QuotaFailureJson = {
  /**
   * Describes all quota violations.
   *
   * @generated from field: repeated google.rpc.QuotaFailure.Violation violations = 1;
 ...
 */
export declare const QuotaFailureSchema: GenMessage<QuotaFailure, {jsonType: QuotaFailureJson}>;
 ...
 * @generated from message google.rpc.QuotaFailure.Violation
 */
export declare type QuotaFailure_ViolationJson = {
  /**
   * The subject on which the quota check failed.
   * For example, "clientip:<ip address of client>" or "project:<Google
   * developer project id>".
 ...
 */
export declare const QuotaFailure_ViolationSchema: GenMessage<QuotaFailure_Violation, {jsonType: QuotaFailure_ViolationJson}>;
 ...
 * @generated from message google.rpc.PreconditionFailure
 */
export declare type PreconditionFailureJson = {
  /**
   * Describes all precondition violations.
   *
   * @generated from field: repeated google.rpc.PreconditionFailure.Violation violations = 1;
 ...
 */
export declare const PreconditionFailureSchema: GenMessage<PreconditionFailure, {jsonType: PreconditionFailureJson}>;
 ...
 * @generated from message google.rpc.PreconditionFailure.Violation
 */
export declare type PreconditionFailure_ViolationJson = {
  /**
   * The type of PreconditionFailure. We recommend using a service-specific
   * enum type to define the supported precondition violation subjects. For
   * example, "TOS" for "Terms of Service violation".
 ...
 */
export declare const PreconditionFailure_ViolationSchema: GenMessage<PreconditionFailure_Violation, {jsonType: PreconditionFailure_ViolationJson}>;
 ...
 * @generated from message google.rpc.BadRequest
 */
export declare type BadRequestJson = {
  /**
   * Describes all violations in a client request.
   *
   * @generated from field: repeated google.rpc.BadRequest.FieldViolation field_violations = 1;
 ...
 */
export declare const BadRequestSchema: GenMessage<BadRequest, {jsonType: BadRequestJson}>;
 ...
 * @generated from message google.rpc.BadRequest.FieldViolation
 */
export declare type BadRequest_FieldViolationJson = {
  /**
   * A path that leads to a field in the request body. The value will be a
   * sequence of dot-separated identifiers that identify a protocol buffer
   * field.
 ...
 */
export declare const BadRequest_FieldViolationSchema: GenMessage<BadRequest_FieldViolation, {jsonType: BadRequest_FieldViolationJson}>;
 ...
 * @generated from message google.rpc.RequestInfo
 */
export declare type RequestInfoJson = {
  /**
   * An opaque string that should only be interpreted by the service generating
   * it. For example, it can be used to identify requests in the service's logs.
   *
 ...
 */
export declare const RequestInfoSchema: GenMessage<RequestInfo, {jsonType: RequestInfoJson}>;
 ...
 * @generated from message google.rpc.ResourceInfo
 */
export declare type ResourceInfoJson = {
  /**
   * A name for the type of resource being accessed, e.g. "sql table",
   * "cloud storage bucket", "file", "Google calendar"; or the type URL
   * of the resource: e.g. "type.googleapis.com/google.pubsub.v1.Topic".
 ...
 */
export declare const ResourceInfoSchema: GenMessage<ResourceInfo, {jsonType: ResourceInfoJson}>;
 ...
 */
export declare const HelpSchema: GenMessage<Help, {jsonType: HelpJson}>;
 ...
 * @generated from message google.rpc.Help.Link
 */
export declare type Help_LinkJson = {
  /**
   * Describes what the link offers.
   *
   * @generated from field: string description = 1;
 ...
 */
export declare const Help_LinkSchema: GenMessage<Help_Link, {jsonType: Help_LinkJson}>;
